"""
Django settings for cryptic_solver_project project.
...
if 'HASKELL_URL' in os.environ:
    haskellURL = os.environ['HASKELL_URL']
else:
    haskellURL = ""

if 'UNLIKELY_PASSWORD' in os.environ:
...
SECRET_KEY = 'django-insecure-1b3t$cyhxcmb+26n#3#@e&rj)q1y((0ll+frv$j7#ny@w%+3wy'
...
MIDDLEWARE = [
    'cryptic_solver_project.newcorsmiddleware.NewCorsMiddleware',
...
ROOT_URLCONF = 'cryptic_solver_project.urls'
...
WSGI_APPLICATION = 'cryptic_solver_project.wsgi.application'
